...
app.post('/save-captured-image', (req, res) => {
    ...
    fs.writeFile(imagePath, base64Data, 'base64', (err) => {
        ...
        exec(`python3 /Users/tuhinrc/Desktop/newnew/MapObjDetctor/scripts/scripting.py --model /Users/tuhinrc/Desktop/newnew/MapObjDetctor/server/best.pt  --source ${imagePath} --nw_lat ${northWest.lat} --nw_lng ${northWest.lng} --se_lat ${southEast.lat} --se_lng ${southEast.lng}`, (error, stdout, stderr) => {
            if (error) {
